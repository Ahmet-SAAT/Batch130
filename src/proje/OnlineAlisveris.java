...
public class OnlineAlisveris {
    ...
    public static void main(String[] args) {
        ...
        urunListesi.add("kitap :urun kodu 3 ");
        urunListesi.add("top :urun kodu 4 ");
    ...
    private static void musteriSecim() {
        ...
        for (int i = 1; i > 0; i++) {
            ...
            double urunTutari = adet * urunFiyatlari.get(secim);
    ...
    private static void odeme() {
        ...
        if (date.isEqual(kurulusGunumuz)) {
            ...
            System.out.println();
        } else if (musterisayisi == odullumusteri) {
            System.out.println("Tebrikler bugun " + odullumusteri + ". musterimiz oldunuz.Hediyeniz kapida!!!");
            System.out.println();
        }else
